...
{
    public partial class BaseServiceTemplate
    {
        ...
        public BaseServiceTemplate(string projectName, string entityName, List<ColumnsModel> sModels, TableModel Models,string repositoryText,
