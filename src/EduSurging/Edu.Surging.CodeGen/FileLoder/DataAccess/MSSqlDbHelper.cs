...
namespace FileLoder.DataAccess
{
    public class MsSqlDbHelper
    {
        ...
        public MsSqlDbHelper(string str)
        {
        ...
        /// 获得分页数据，返回总行数
        /// </summary>
        public DataSet GetPageList(string SqlAllFields, string SqlTablesAndWhere, string OrderFields, int pageindex, int pagesize, out int recordcount, params SqlParameter[] cmdParms)
        {
            recordcount = 0;
