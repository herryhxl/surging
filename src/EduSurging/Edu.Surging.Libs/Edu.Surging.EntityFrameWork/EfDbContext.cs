...
namespace Edu.Surging.EntityFramework
{
    ...
    public abstract class EfDbContext : DbContext, IDbContext
    {
        ...
        //            && (type.BaseType.GetGenericTypeDefinition() == typeof(EfEntityTypeConfiguration<>) //typeof(EfEntityTypeConfiguration<>) 
        //                || type.BaseType.GetGenericTypeDefinition() == typeof(EfQueryTypeConfiguration<>)));
        ...
        public virtual DbSet<TEntity> Set<TEntity, T>() where TEntity : BaseEntity<T>
        {
        ...
        /// <param name="parameters">The values to be assigned to parameters</param>
        /// <returns>An IQueryable representing the raw SQL query</returns>
        public virtual IQueryable<TEntity> EntityFromSql<TEntity,T>(string sql, params object[] parameters) where TEntity : BaseEntity<T>
        {
        ...
        public virtual void Detach<TEntity,T>(TEntity entity) where TEntity : BaseEntity<T>
        {
            if (entity == null)
