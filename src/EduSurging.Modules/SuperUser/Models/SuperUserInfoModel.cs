...
namespace SuperUser.Models
{
	...
	public class SuperUserInfoModel:SuperUserInfo_DataModel
	{
		public string SuperUserInfoText { get; set; }
		public string IdText { get; set; }
			public SuperUserModel Id_SuperUser { get; set; }
			public int Id_SuperUserCount { get; set; }
			}
}