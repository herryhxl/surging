...
namespace FileLoder
{
    ...
    {
        public static void WriteToExcel(string saveFilePath, List<TableModel> Table, Main.UpdateUi update, Main myUi)
        {
                        ...
                        foreach (XmlNode item5 in item4.ChildNodes)
                        {
                            ...
                            foreach (XmlNode item6 in item5.ChildNodes)
                            {
                                if (item6.LocalName == "Columns")
                                {
                                    ...
                                    foreach (XmlNode item7 in item6.ChildNodes)
                                    {
                                        ColumnsModel columnsModel = new ColumnsModel { IsNull = true };
                                        ...
                                        foreach (XmlNode item8 in item7.ChildNodes)
                                        {
                                            ...
                                            if (item8.LocalName == "Comment")
                                            {
                                                ...
                                                if (item8.InnerText.Trim() != "")
                                                {
                                                    ...
                                                    {
                                                        if (model.Count == 1)
                                                            throw new Exception(string.Format("表名：{0}，字段：{1}的枚举书写有误", tabModel.Code, columnsModel.Code));
                                                        columnsModel.EM = true;
                                                        //columnsModel.EnumName = EnumName;
                                            ...
                                            if (item8.LocalName == "Identity")
                                            {
                                                columnsModel.IsAutoAdd = true;
                                            }
                                            if (item8.LocalName == "Column.Mandatory")
                                            {
                                                columnsModel.IsNull = false;
                                            }
                                        }
        ...
        public static bool CreateCodeFiles(CodePara code, Main.UpdateUi update, Main myUi)
        {
