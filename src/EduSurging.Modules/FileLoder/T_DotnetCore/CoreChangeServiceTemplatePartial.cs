...
{
    public partial class CoreChangeServiceTemplate
    {
        ...
        public CoreChangeServiceTemplate(string projectName, string entityName, List<ColumnsModel> sModels, TableModel Models, string repositoryText,
