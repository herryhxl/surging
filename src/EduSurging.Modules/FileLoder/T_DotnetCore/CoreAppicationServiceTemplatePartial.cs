...
{
    public partial class CoreApplicationServiceTemplate
    {
        ...
        public CoreApplicationServiceTemplate(string projectName, string entityName, List<ColumnsModel> sModels, TableModel Models, string repositoryText,
