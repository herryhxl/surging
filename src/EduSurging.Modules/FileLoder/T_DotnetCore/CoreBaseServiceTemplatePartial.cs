...
{
    public partial class CoreBaseServiceTemplate
    {
        ...
        public CoreBaseServiceTemplate(string projectName, string entityName, List<ColumnsModel> sModels, TableModel Models, string repositoryText,
